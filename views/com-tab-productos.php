<section>
	<article>
		<div class="col col-49">
			...
			<div id="doloveck" class="content-prod active">
				<h2 class="animated fadeInUp">Doloveck</h2>
			...
			<div id="atenolen" class="content-prod">
			...
			<div id="soprapen" class="content-prod">
				<h2 class="animated fadeInUp">Soprapen</h2>
				<ul class="animated fadeInUp">
