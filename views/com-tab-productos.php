<section>
	<article>
		<div class="col col-49">
			...
			<div id="amlodipen25mg" class="content-prod active">
				<h2 class="animated fadeInUp">Amlodipen 2.5mg</h2>
				<ul class="animated fadeInUp">
					<li><em>Principio Activo:</em> S(-) Amlodipina Besilato 2.5 mg</li>
			...
			<div id="amlodipenD5mg" class="content-prod">
				...
				<ul class="animated fadeInUp">
					<li><em>Principio Activo:</em> S(-) Amlodipina + Hidroclorotiazida 5/12.5 mg</li>
					<li><em>Categoría terapéutica:</em> Antipertensivo</li>
					<li><em>Indicaciones:</em> Angina de pecho, hipertensión arterial. *Para mayor información descargue el inserto médico.</li>
					<li><em>Presentación:</em> Caja con 30 tabletas recubiertas</li>
					<li><em>Dosis:</em> Consulte a su médico</li>
			...
			<div id="amlodipenLS" class="content-prod">
				...
				<ul class="animated fadeInUp">
					<li><em>Principio Activo:</em> S(-) Amlodipina losaran potásico 2.5/50 mg</li>
					<li><em>Categoría terapéutica:</em> Antipertensivo</li>
					<li><em>Indicaciones:</em> Angina de pecho, hipertensión arterial. *Para mayor información descargue el inserto médico.</li>
					<li><em>Presentación:</em> Caja con 30 tabletas recubiertas</li>
					<li><em>Dosis:</em> Consulte a su médico</li>
			...
			<div id="atenolenS50mg" class="content-prod">
				...
				<ul class="animated fadeInUp">
					<li><em>Principio Activo:</em> S(-) Atenolol S 50 mg</li>
					<li><em>Categoría terapéutica:</em> Antihipertensivo</li>
					<li><em>Indicaciones:</em> Angina de pecho, hipertensión arterial. *Para mayor información descargue el inserto médico.</li>
					<li><em>Presentación:</em> Caja con 30 tabletas recubiertas</li>
					<li><em>Dosis:</em> Consulte a su médico</li>
			...
			<div id="soprapenIV" class="content-prod">
				...
				<ul class="animated fadeInUp">
					<li><em>Principio Activo:</em> S(-) Pantoprazol 20 mg</li>
					<li><em>Categoría terapéutica:</em> Anti úlceras.</li>
					<li><em>Indicaciones:</em> Enfermedad de reﬂujo gasto esofágico, úlceras pépticas y dispepsia  *Para mayor información descargue el inserto médico.</li>
					<li><em>Presentación:</em> I.V</li>
					<li><em>Dosis:</em> Consulte a su médico</li>
					<li><em>Disponible en:</em> Honduras y Guatemala.</li>
				</ul>
		...
		<div class="col col-51">
            <ul class="list-prod">
                ...
                <li>
                	<a href="#atenolen50mg">
	                	<figure>
	            			<img src="images/productos/atenolen50mg.png" alt="Atenolen 50mg" />
							<span class="borderCurrent"></span>
	            		</figure>
                	</a>
                </li>
                ...
                <li>
                	<a href="#soprapenIV" id="selector_soprapen">
						<figure>
